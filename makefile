...
all-codegen-target-objects = $(call target-objects,$(all-codegen-target-sources),$(src),$(build))
...
heapwalk-objects = $(call target-objects,$(heapwalk-sources))
...
bootimage-generator-objects = $(call target-objects,$(bootimage-generator-sources))
...
$(all-codegen-target-objects): $(vm-depends)
endif
...
$(bootimage-generator-objects): $(vm-depends)

$(heapwalk-objects): $(vm-depends)
...
unittest-executable-objects = $(unittest-objects) $(vm-objects) \
	$(call target-objects,$(src)/util/arg-parser.cpp) $(stub-objects) $(lzma-decode-objects)
