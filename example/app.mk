...
base = $(shell pwd)
vm = $(root)
swt = thirdparty/swt/$(full-platform)/swt.jar
src = src
...
dlltool = dlltool
proguard = thirdparty/proguard5.2.1/lib/proguard.jar
...
$(classes): $(sources) $(jars)
	$(make-vm)
	@mkdir -p $(stage1)
	$(javac) -source 1.6 -target 1.6 -d $(stage1) -sourcepath $(src) \
...
$(bld)/boot.jar: \
		$(classes) $(properties) $(jars) $(vm-classes)
	@mkdir -p $(dir $(bld)/tmp)
ifdef proguard
	$(java) -jar $(proguard) \
		-injars $(stage1) \
